...
(library Library_1
	...
	(patternDef "MCU20N06BHE3TP" (originalName "MCU20N06BHE3TP")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt -0.258, 0.000) (textStyleRef "Default") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -4.112 -3.3) (pt 1.987 -3.3) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 1.987 -3.3) (pt 1.987 3.3) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 1.987 3.3) (pt -4.112 3.3) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt -4.112 3.3) (pt -4.112 -3.3) (width 0.1))
		)
	...
	(compDef "MCU20N06BHE3-TP" (originalName "MCU20N06BHE3-TP") (compHeader (numPins 3) (numParts 1) (refDesPrefix Q)
		...
		(attr "Datasheet Link" "https://www.mccsemi.com/pdf/Products/MCU20N06BHE3(DPAK).pdf")
		(attr "Height" "2.53 mm")
	)
