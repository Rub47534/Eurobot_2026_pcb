...
//282811/1869775/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "LM393ADR" (originalName "LM393ADR")
	...
	(compDef "LM393ADR" (originalName "LM393ADR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "LM393ADR"))
		...
		(attr "Manufacturer_Part_Number" "LM393ADR")
		(attr "Mouser Part Number" "595-LM393ADR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/LM393ADR?qs=VolsR0DjNPq76ZV6Dhd8nQ%3D%3D")
		(attr "Arrow Part Number" "LM393ADR")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/lm393adr/texas-instruments?utm_currency=USD&region=nac")
		(attr "Description" "TEXAS INSTRUMENTS - LM393ADR - COMPARATOR DUAL, SMD, SOIC8, 393")
		(attr "<Hyperlink>" "http://www.ti.com/lit/ds/symlink/lm393a.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "LM393ADR.stp")
