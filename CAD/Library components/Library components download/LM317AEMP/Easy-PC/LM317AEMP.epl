SamacSys ECAD Model
299040/1869775/2.50/4/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "LM317AEMP" (originalName "LM317AEMP")
	...
	(compDef "LM317AEMP" (originalName "LM317AEMP") (compHeader (numPins 4) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "ADJ") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "LM317AEMP"))
		...
		(attr "Manufacturer_Part_Number" "LM317AEMP")
		(attr "Mouser Part Number" "926-LM317AEMP")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/LM317AEMP?qs=X1J7HmVL2ZGkQwt18De0Dg%3D%3D")
		(attr "Arrow Part Number" "LM317AEMP")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/lm317aemp/texas-instruments?region=europe")
		(attr "Description" "TEXAS INSTRUMENTS - LM317AEMP... - V REG ADJ +1.2/37V, SOT-223-3, 317")
		(attr "Datasheet Link" "http://www.ti.com/general/docs/lit/getliterature.tsp?genericPartNumber=LM317A&&fileType=pdf")
		(attr "Height" "1.8 mm")
	)
