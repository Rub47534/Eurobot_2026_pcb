...
(library Library_1
	...
	(patternDef "USBA1VSB6" (originalName "USBA1VSB6")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 3.500, -1.850) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -3.1 1.6) (pt 10.1 1.6) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 10.1 1.6) (pt 10.1 -5.3) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 10.1 -5.3) (pt -3.1 -5.3) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -3.1 -5.3) (pt -3.1 1.6) (width 0.025))
		)
	...
	(compDef "USB-A1VSB6" (originalName "USB-A1VSB6") (compHeader (numPins 6) (numParts 1) (refDesPrefix J)
		...
		(attr "<Hyperlink>" "http://www.on-shore.com/wp-content/uploads/USB-A1VSXX.pdf")
		(attr "<Component Height>" "13.7")
		(attr "<STEP Filename>" "USB-A1VSB6.stp")
